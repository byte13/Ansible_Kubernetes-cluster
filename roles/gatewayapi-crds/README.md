# GatewayAPI Custom Resources Definitions (CRD's) for supporting controllers 
This Ansible role installs GatewayAPI Custom Resources Definitions (CRD's)
...
1. Possibly adjust variables in role/gateway-crds/var/main.yml (check comments in the file to understand effect of respective variables)
